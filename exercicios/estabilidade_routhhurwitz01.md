...
```math
c_1 = -\frac{\begin{bmatrix} 1 & 1 \\ k-1 & -k+1 \end{bmatrix}}{k-1} = -\frac{1-k}{k-1} = 1, 
...
```math
d_1 = -\frac{\begin{bmatrix} k-1 & -k+1 \\ 1 & -k \end{bmatrix}}{1} = -\frac{-K^2+k-(-k+1)}{1} = k^2-2k+1, 
d_2 = -\frac{\begin{bmatrix} k-1 & 0 \\ 1 & 0 \end{bmatrix}}{1} = -\frac{0}{1} = 0 
```
...
```math
e_1 = -\frac{\begin{bmatrix} 1 & -k \\ k^2-2k+1 & 0 \end{bmatrix}}{k^2-2k+1} = -\frac{k(k^2-2k+1)}{k^2-2k+1} = -k 
```
