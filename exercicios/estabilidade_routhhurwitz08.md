...
```
```math
\Delta_2 = \begin{vmatrix} k+2 & k+1 \\ 1 & 2k+1 \end{vmatrix} > 0 \Rightarrow  (k+2)(2k+1) - (k+1)(1) = 2k^2 + k + 4k + 2 - k - 1 = 2k^2 + 4k + 1 > 0 \Rightarrow k < -1-\frac{1}{2}\sqrt{2} ou k > -1+\frac{1}{2}\sqrt{2}
```
```math
