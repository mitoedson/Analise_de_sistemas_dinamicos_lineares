...
```
```math
\Delta_3 = \begin{vmatrix} k+2 & k+1 & 0\\ 1 & 2k+1 & 0\\ 0 & k+2 & k+1 \end{vmatrix} > 0 \Rightarrow
```
```math
\Rightarrow (k+2)(2k+1)(k+1) - (1)(k+1)(k+1) = (k+1)[(2k+1)(k+2)-(K+1)] = (k+1)(2k^2+4k+k+2-k-1) = (k+1)(2k^2+4k+1) = 0 
```
```math
\Rightarrow k = 1, k < -1-\frac{1}{2}\sqrt{2}\qquad\text{ou}\qquad k > -1+\frac{1}{2}\sqrt{2}
```
