...
$$
\frac{dx}{dt}=2x+2y,\quad \frac{dy}{dt}=x+3y \quad\Rightarrow\quad A=\begin{bmatrix}2&2\\1&3\end{bmatrix}
$$
...
$$
\frac{dx}{dt}=-4x+2y,\quad \frac{dy}{dt}=-\frac{5}{2}x+2y \quad\Rightarrow\quad A=\begin{bmatrix}-4&2\\-5/2&2\end{bmatrix}
$$
...
$$
\frac{dx}{dt}=-\frac{5}{2}x+2y,\quad \frac{dy}{dt}=\frac{3}{4}x-2y \quad\Rightarrow\quad A=\begin{bmatrix}-5/2&2\\3/4&-2\end{bmatrix}
$$
