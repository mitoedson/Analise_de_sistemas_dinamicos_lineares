...
$$
\begin{aligned}
m_1 \ddot{y}_1 + (b_1+b_2) \dot{y}_1 - b_2 \dot{y}_2 + (k_1+k_2) y_1 - k_2 y_2 &= u_1(t) \\
...
\dot{x}_1 = x_3 \\
\dot{x}_2 = x_4 \\
\dot{x}_3 = \dfrac{1}{m_1}\Bigl[ u_1 - (b_1+b_2)x_3 + b_2 x_4 - (k_1+k_2)x_1 + k_2 x_2 \Bigr] \\
...
0 & 0 & 1 & 0 \\
0 & 0 & 0 & 1 \\
-\dfrac{k_1+k_2}{m_1} & \dfrac{k_2}{m_1} & -\dfrac{b_1+b_2}{m_1} & \dfrac{b_2}{m_1} \\
