Vamos analisar a **Questão 7** — controlabilidade e observabilidade de um sistema linear com 3 estados.
...
$$\mathcal C = \begin{bmatrix}B & AB & A^2B\end{bmatrix} \quad (\text{para sistema de ordem } n=3)$$
